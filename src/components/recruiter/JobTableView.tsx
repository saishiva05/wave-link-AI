    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <span className={cn(
          ...
          isLinkedIn ? "bg-[#0A66C2]/10 text-[#0A66C2]" : "bg-secondary-100 text-secondary-600"
        )}>
          {isLinkedIn ? (
            ...
            <span className="text-[10px] font-bold leading-none">{platform.slice(0, 2).toUpperCase()}</span>
          )}
        </span>
      </TooltipTrigger>

...
import RecruiterDetailModal from "./RecruiterDetailModal";
      ...
      <div className="bg-card border border-border rounded-xl shadow-card overflow-hidden">
          ...
          <table className="w-full">
            ...
            <tbody>
              {recruiters.map((r: any) => {
                ...
                return (
                  <tr key={r.recruiter_id} className="border-b border-border hover:bg-muted/50 transition-colors group cursor-pointer" onClick={() => openDetail(r)}>
                    ...
                    <td className="px-4 py-3 text-right" onClick={(e) => e.stopPropagation()}>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-44">
                          <DropdownMenuItem onClick={() => openDetail(r)}><Eye className="w-4 h-4 mr-2" /> View Details</DropdownMenuItem>
                          <DropdownMenuItem onClick={() => openDetail(r)}><Edit className="w-4 h-4 mr-2" /> Edit Recruiter</DropdownMenuItem>
        ...
        <div className="md:hidden divide-y divide-border">
          {recruiters.map((r: any) => {
            ...
            const isActive = user?.is_active ?? true;
            return (
              <div key={r.recruiter_id} className="p-4 space-y-3 hover:bg-muted/30 transition-colors cursor-pointer" onClick={() => openDetail(r)}>

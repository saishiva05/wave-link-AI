      ...
      <DialogContent className="sm:max-w-[560px] p-0 gap-0 rounded-2xl">
        {success ? (
          <div className="flex flex-col items-center justify-center py-12 px-8 text-center animate-fade-in">
            ...
            <h2 className="text-xl font-bold text-foreground mb-2 font-display">Recruiter Account Created!</h2>
          ...
          <>
            <DialogHeader className="px-6 pt-6 pb-4 border-b border-border">
              <DialogTitle className="text-xl font-bold text-foreground font-display">Create New Recruiter Account</DialogTitle>
            </DialogHeader>
            <div className="px-6 py-5 space-y-5 max-h-[60vh] overflow-y-auto">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <Label htmlFor="sendInvite" className="text-sm text-foreground cursor-pointer">Send login credentials via email</Label>
